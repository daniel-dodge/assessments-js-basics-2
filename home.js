...
const returnGreeting = greetUser("djsalj")
...
const deliveryMessage = canWeDeliver(852021)
...
const deliveryMessageTwo = canWeDeliverTwo(85205)
console.log(deliveryMessageTwo)
//////////////////PROBLEM 3////////////////////
/* 
...
newTitle = deals[0].title.replace('15%','10%')
...
newDesc = deals[1].desc.replace('March','April').trim()
console.log(newDesc)